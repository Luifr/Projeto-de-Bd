...
CREATE TABLE AGENTE (
    ...
    CONSTRAINT CK_TIPO CHECK ((TIPO) IN ('APRESENTADOR', 'CAMERAMAN_S', 'CAMERAMAN_C', 'AUXILIAR_S', 'AUXILIAR_C', 'REPORTER', 'MOTORISTA'))
);
...
CREATE TABLE NOTICIA (
    ...
    NOMEACONT VARCHAR(40) NOT NULL,
    DATAACONT DATE NOT NULL,
    REDATOR CHAR(14),
    PRODUTOR CHAR(14),
...
-- coloquei o delete da FK como cascade, não vejo pq deletar acontecimento se n for pra remover tudo associado a ele.
...
CREATE TABLE PERTENCE (
    ...
    HORA TIME,
    CONSTRAINT PK_PERTENCE PRIMARY KEY (EPISODIO, NROBLOCO, FILMBRUTA, NROEDIC),
    CONSTRAINT FK1_PERTENCE FOREIGN KEY (EPISODIO, NROBLOCO) REFERENCES BLOCO (EPISODIO, NROBLOCO) ON DELETE CASCADE,
    CONSTRAINT FK2_PERTENCE FOREIGN KEY (FILMBRUTA, NROEDIC) REFERENCES FILMAGEMEDITADA (FILMBRUTA, NROEDICAO) ON DELETE CASCADE
);
...
CREATE TABLE PROPAGANDA (
    ...
    NOMEPROPAGANDA VARCHAR(40) NOT NULL,
    DURACAO INT,
    VALOR FLOAT,
